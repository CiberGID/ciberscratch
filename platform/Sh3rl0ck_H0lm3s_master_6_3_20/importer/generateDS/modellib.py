...
#
# Generated Thu Mar  5 16:55:44 2020 by generateDS.py version 2.33.1.
...
#
# Command line:
#   ./generateDS.py -f -o "modellib.py" --member-specs="list" ../static/xsd/model.xsd
#
...
class Game(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('course_id', 'xs:long', 0, 0, {'use': 'required'}),
        MemberSpec_('name', 'xs:string', 0, 0, {'use': 'required'}),
        MemberSpec_('description', 'xs:string', 0, 1, {'use': 'optional'}),
        MemberSpec_('published_date', 'xs:dateTime', 0, 1, {'use': 'optional'}),
        MemberSpec_('is_published', 'xs:boolean', 0, 0, {'use': 'required'}),
        MemberSpec_('game_image', 'xs:anyURI', 0, 1, {'use': 'optional'}),
        MemberSpec_('case', 'Case', 1, 0, {'maxOccurs': 'unbounded', 'name': 'case', 'type': 'Case'}, None),
    ]
    subclass = None
    superclass = None
...
class Case(GeneratedsSuper):
    ...
    comprimido."""
    member_data_items_ = [
        MemberSpec_('game_id', 'xs:long', 0, 1, {'use': 'optional'}),
        MemberSpec_('name', 'xs:string', 0, 0, {'use': 'required'}),
        MemberSpec_('description', 'xs:string', 0, 1, {'use': 'optional'}),
        MemberSpec_('published_date', 'xs:dateTime', 0, 1, {'use': 'optional'}),
        MemberSpec_('is_published', 'xs:boolean', 0, 0, {'use': 'required'}),
        MemberSpec_('base_img_path', 'xs:anyURI', 0, 0, {'use': 'required'}),
        MemberSpec_('case_image', 'xs:anyURI', 0, 1, {'use': 'optional'}),
        MemberSpec_('protocol', 'xs:string', 0, 1, {'use': 'optional'}),
        MemberSpec_('terminal_username', 'xs:string', 0, 1, {'use': 'optional'}),
        MemberSpec_('character', 'Character', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'character', 'type': 'Character'}, None),
        MemberSpec_('story', 'Story', 0, 0, {'name': 'story', 'type': 'Story'}, None),
        MemberSpec_('event', 'Event', 1, 0, {'maxOccurs': 'unbounded', 'name': 'event', 'type': 'Event'}, None),
        MemberSpec_('artifact', 'Artifact', 1, 0, {'maxOccurs': 'unbounded', 'name': 'artifact', 'type': 'Artifact'}, None),
    ]
    subclass = None
    superclass = None
...
class Character(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('character_key', 'xs:string', 0, 0, {'use': 'required'}),
        MemberSpec_('name', 'xs:string', 0, 0, {'use': 'required'}),
        MemberSpec_('full_name', 'xs:string', 0, 0, {'use': 'required'}),
        MemberSpec_('mail_address', 'xs:string', 0, 1, {'use': 'optional'}),
        MemberSpec_('avatar_path', 'xs:anyURI', 0, 1, {'use': 'optional'}),
    ]
    subclass = None
    superclass = None
...
class Message(GeneratedsSuper):
    ...
    ruta dentro del comprimido."""
    member_data_items_ = [
        MemberSpec_('order', 'xs:int', 0, 1, {'use': 'optional'}),
        MemberSpec_('delay_to_show', 'xs:int', 0, 1, {'use': 'optional'}),
        MemberSpec_('character_key', 'xs:string', 0, 1, {'use': 'optional'}),
        MemberSpec_('plane_text', 'xs:string', 0, 1, {'minOccurs': '0', 'name': 'plane_text', 'type': 'xs:string'}, None),
        MemberSpec_('file_path', 'xs:anyURI', 0, 1, {'minOccurs': '0', 'name': 'file_path', 'type': 'xs:anyURI'}, None),
    ]
    subclass = None
    superclass = None
...
class Story(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('name', 'xs:string', 0, 0, {'use': 'required'}),
        MemberSpec_('description', 'xs:string', 0, 1, {'use': 'optional'}),
        MemberSpec_('story_type_id', 'xs:long', 0, 0, {'use': 'required'}),
        MemberSpec_('message', 'Message', 1, 0, {'maxOccurs': 'unbounded', 'name': 'message', 'type': 'Message'}, None),
    ]
    subclass = None
    superclass = None
...
class StoryType(GeneratedsSuper):
    ...
    permitidos."""
    member_data_items_ = [
        MemberSpec_('id', 'xs:long', 0, 0, {'use': 'required'}),
    ...
    def validate_nameType(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            value = str(value)
            enumerations = ['on_screen', 'pdf', 'chat', 'email', 'html', 'audio', 'video']
...
class Event(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('event_key', 'xs:string', 0, 1, {'use': 'optional'}),
        MemberSpec_('case_id', 'xs:long', 0, 1, {'use': 'optional'}),
        MemberSpec_('name', 'xs:string', 0, 0, {'use': 'required'}),
        MemberSpec_('description', 'xs:string', 0, 1, {'use': 'optional'}),
        MemberSpec_('previous_event_key', 'xs:string', 0, 1, {'use': 'optional'}),
        MemberSpec_('previous_event_id', 'xs:long', 0, 1, {'use': 'optional'}),
        MemberSpec_('delay_start', 'xs:int', 0, 1, {'use': 'optional'}),
        MemberSpec_('onfinish_cancel_active_events', 'xs:boolean', 0, 1, {'use': 'optional'}),
        MemberSpec_('event_intro_story', 'Story', 0, 1, {'minOccurs': '0', 'name': 'event_intro_story', 'type': 'Story'}, None),
        MemberSpec_('event_end_story', 'Story', 0, 1, {'minOccurs': '0', 'name': 'event_end_story', 'type': 'Story'}, None),
    ]
    subclass = None
    superclass = None
...
class Artifact(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('name', 'xs:string', 0, 0, {'use': 'required'}),
        MemberSpec_('description', 'xs:string', 0, 1, {'use': 'optional'}),
        MemberSpec_('path', 'xs:anyURI', 0, 1, {'use': 'optional'}),
        MemberSpec_('artifact_type', 'ArtifactType', 0, 0, {'name': 'artifact_type', 'type': 'ArtifactType'}, None),
        MemberSpec_('hidden_info', 'HiddenInfo', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'hidden_info', 'type': 'HiddenInfo'}, None),
    ]
    subclass = None
    superclass = None
...
class HiddenInfo(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('name', 'xs:string', 0, 0, {'use': 'required'}),
        MemberSpec_('description', 'xs:string', 0, 1, {'use': 'optional'}),
        MemberSpec_('hiding_type_id', 'xs:long', 0, 0, {'use': 'required'}),
        MemberSpec_('score', 'xs:int', 0, 1, {'use': 'optional'}),
        MemberSpec_('event_key', 'xs:string', 0, 1, {'use': 'optional'}),
        MemberSpec_('is_event_key_info', 'xs:boolean', 0, 0, {'use': 'required'}),
        MemberSpec_('common_key_code', 'xs:string', 0, 1, {'use': 'optional'}),
        MemberSpec_('prefix_key_code', 'xs:string', 0, 1, {'use': 'optional'}),
        MemberSpec_('suffix_key_code', 'xs:string', 0, 1, {'use': 'optional'}),
        MemberSpec_('random_key_code_word', 'xs:boolean', 0, 1, {'use': 'optional'}),
        MemberSpec_('random_word_maxlength', 'xs:int', 0, 1, {'use': 'optional'}),
        MemberSpec_('toolParamValue', 'ToolParamValue', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'toolParamValue', 'type': 'ToolParamValue'}, None),
        MemberSpec_('clue', 'Clue', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'clue', 'type': 'Clue'}, None),
    ]
    subclass = None
    superclass = None
    def __init__(self, name=None, description=None, hiding_type_id=None, score=0, event_key=None, is_event_key_info=None, common_key_code=None, prefix_key_code=None, suffix_key_code=None, random_key_code_word=None, random_word_maxlength=None, toolParamValue=None, clue=None, **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        self.name = _cast(None, name)
    ...
    def set_clue(self, clue):
        self.clue = clue
    def add_clue(self, value):
        self.clue.append(value)
    def insert_clue_at(self, index, value):
        self.clue.insert(index, value)
    def replace_clue_at(self, index, value):
        self.clue[index] = value
    def get_name(self):
        return self.name
    def set_name(self, name):
        self.name = name
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:game="https://game.sherlock_holmes.com"', name_='HiddenInfo', fromsubclass_=False, pretty_print=True):
        ...
        for clue_ in self.clue:
            namespaceprefix_ = self.clue_nsprefix_ + ':' if (UseCapturedNS_ and self.clue_nsprefix_) else ''
            clue_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='clue', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.ns_prefix_ = node.prefix
        self.buildAttributes(node, node.attrib, already_processed)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'toolParamValue':
            ...
            obj_ = Clue.factory(parent_object_=self)
            obj_.build(child_)
            self.clue.append(obj_)
            obj_.original_tagname_ = 'clue'
# end class HiddenInfo


class Clue(GeneratedsSuper):
    """Una pista para ayudar al estudiente en el juego."""
    member_data_items_ = [
        MemberSpec_('order', 'xs:long', 0, 0, {'use': 'required'}),
        MemberSpec_('cost', 'xs:long', 0, 1, {'use': 'optional'}),
        MemberSpec_('clue_text', 'xs:string', 0, 0, {'name': 'clue_text', 'type': 'xs:string', 'use': 'required'}, None),
    ]
    subclass = None
    superclass = None
    def __init__(self, order=None, cost=None, clue_text=None, **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        self.order = _cast(int, order)
        ...
        self.clue_text_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, Clue)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if Clue.subclass:
            return Clue.subclass(*args_, **kwargs_)
        else:
            return Clue(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
        self.ns_prefix_ = ns_prefix
    def get_clue_text(self):
        return self.clue_text
    def set_clue_text(self, clue_text):
        self.clue_text = clue_text
    def get_order(self):
        return self.order
    def set_order(self, order):
    ...
    def hasContent_(self):
        if (
            self.clue_text is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:game="https://game.sherlock_holmes.com"', name_='Clue', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('Clue')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='Clue')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='Clue', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Clue'):
        if 'order' not in already_processed:
            already_processed.add('order')
            outfile.write(' order="%s"' % self.gds_format_integer(self.order, input_name='order'))
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:game="https://game.sherlock_holmes.com"', name_='Clue', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.clue_text is not None:
            namespaceprefix_ = self.clue_text_nsprefix_ + ':' if (UseCapturedNS_ and self.clue_text_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sclue_text>%s</%sclue_text>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.clue_text), input_name='clue_text')), namespaceprefix_ , eol_))
    def build(self, node):
        already_processed = set()
        self.ns_prefix_ = node.prefix
        self.buildAttributes(node, node.attrib, already_processed)
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'cost' not in already_processed:
            ...
            try:
                ...
                raise_parse_error(node, 'Bad integer attribute: %s' % exp)
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'clue_text':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'clue_text')
            value_ = self.gds_validate_string(value_, node, 'clue_text')
            self.clue_text = value_
            self.clue_text_nsprefix_ = child_.prefix
# end class Clue
...
class ToolParamValue(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('param_id', 'xs:long', 0, 0, {'use': 'required'}),
        MemberSpec_('tool_id', 'xs:long', 0, 0, {'use': 'required'}),
        MemberSpec_('value', 'xs:string', 0, 1, {'use': 'optional'}),
        MemberSpec_('add_key_code', 'xs:boolean', 0, 1, {'use': 'optional'}),
    ]
    subclass = None
    superclass = None
...
class Tools(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('tool', 'Tool', 1, 0, {'maxOccurs': 'unbounded', 'name': 'tool', 'type': 'Tool'}, None),
    ]
    subclass = None
    superclass = None
...
class Tool(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('name', 'xs:string', 0, 0, {'use': 'required'}),
        MemberSpec_('description', 'xs:string', 0, 1, {'use': 'optional'}),
        MemberSpec_('command', 'xs:string', 0, 0, {'use': 'required'}),
        MemberSpec_('hiding_type', 'HidingType', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'hiding_type', 'type': 'HidingType'}, None),
        MemberSpec_('parameter', 'ToolParameter', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'parameter', 'type': 'ToolParameter'}, None),
    ]
    subclass = None
    superclass = None
...
class Department(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('name', 'xs:string', 0, 0, {'use': 'required'}),
        MemberSpec_('url', 'xs:anyURI', 0, 1, {'use': 'optional'}),
        MemberSpec_('course', 'Course', 1, 0, {'maxOccurs': 'unbounded', 'name': 'course', 'type': 'Course'}, None),
    ]
    subclass = None
    superclass = None
...
class Course(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('name', 'xs:string', 0, 0, {'use': 'required'}),
        MemberSpec_('acronym', 'xs:string', 0, 1, {'use': 'optional'}),
        MemberSpec_('course_image', 'xs:anyURI', 0, 1, {'use': 'optional'}),
    ]
    subclass = None
    superclass = None
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from modellib import *\n\n')
        sys.stdout.write('import modellib as model_\n\n')
