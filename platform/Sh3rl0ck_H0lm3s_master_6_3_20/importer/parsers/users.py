...
#
# Generated Tue Sep 17 00:39:46 2019 by generateDS.py version 2.33.1.
...
#   ../static/xsd/users.xsd
#
# Command line:
#   generateDS.py --external-encoding="utf-8" -f -o "../parsers/users.py" ../static/xsd/users.xsd
#
...
class Users(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, user=None, **kwargs_):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:user="https://user.sherlock_holmes.com"', name_='Users', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Users'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:user="https://user.sherlock_holmes.com"', name_='Users', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class User(GeneratedsSuper):
    """Un usuario tiene que tener nombre de usuario y una dirección email. Si
    ...
    subclass = None
    superclass = None
    def __init__(self, username=None, email_address=None, is_professor=False, **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        self.username = _cast(None, username)
        self.username_nsprefix_ = None
        self.email_address = _cast(None, email_address)
        self.email_address_nsprefix_ = None
        self.is_professor = _cast(bool, is_professor)
        self.is_professor_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def validate_email(self, value):
        # Validate type user:email, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_email_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_email_patterns_, ))
    validate_email_patterns_ = [['^([^@]+@[^\\.]+\\..+)$']]
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:user="https://user.sherlock_holmes.com"', name_='User', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='User'):
        ...
        if 'email_address' not in already_processed:
            already_processed.add('email_address')
            outfile.write(' email_address=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.email_address), input_name='email_address')), ))
        if self.is_professor and 'is_professor' not in already_processed:
            already_processed.add('is_professor')
            outfile.write(' is_professor="%s"' % self.gds_format_boolean(self.is_professor, input_name='is_professor'))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:user="https://user.sherlock_holmes.com"', name_='User', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.ns_prefix_ = node.prefix
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'username' not in already_processed:
            already_processed.add('username')
            self.username = value
        value = find_attr_value_('email_address', node)
        if value is not None and 'email_address' not in already_processed:
            already_processed.add('email_address')
            self.email_address = value
            self.validate_email(self.email_address)    # validate type email
        value = find_attr_value_('is_professor', node)
        if value is not None and 'is_professor' not in already_processed:
            already_processed.add('is_professor')
            if value in ('true', '1'):
...
def parseString(inString, silence=False):
    ...
    if not silence:
        ...
        rootObj.export(
            sys.stdout, 0, name_=rootTag,
            namespacedef_='xmlns:user="https://user.sherlock_holmes.com"')
    return rootObj
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from users import *\n\n')
        sys.stdout.write('import users as model_\n\n')
